...
# song1 = pygame.mixer.Sound(os.path.abspath(__file__ + "/../sounds/1.mp3"))
# song2 = pygame.mixer.Sound(os.path.abspath(__file__ + "/../sounds/2.mp3"))
# song3 = pygame.mixer.Sound(os.path.abspath(__file__ + "/../sounds/3.mp3"))
