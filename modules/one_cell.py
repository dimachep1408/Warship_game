...
class OneCellsShip():
    def __init__(self, matrix_x, x, y, rotation=True, killed = False):
        ...
        if killed:
            self.ship_surf = pygame.image.load(os.path.abspath(__file__ + "/../../images/one_cells_ship_killed.png"))
        else:
            self.ship_surf = pygame.image.load(os.path.abspath(__file__ + "/../../images/1_cells_ship.png"))

        # Масштабирование
        self.ship_surf = pygame.transform.scale(self.ship_surf, (45, 45))
