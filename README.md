...
3. >Обов'язково завантажте усі модулі шо будуть написані нижче, щоб гра змогла працювати так як треба. / You need to install all modules that you may seen down there, for game start working properly.
4. >Також обов'язково напишіть свій айпі, щоб гра змогла приєднати вас. / You need to write down your IP in main.py, so game can join you.
...
2. >After you saw a menu with ships and grid, place them where you want, or lust use "auto" button. / Після того, що ви побачили меню з кораблями та полем, розташуйте їх де хочете, або ж просто натисніть на кнопку "auto"ю
